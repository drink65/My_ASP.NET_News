<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zhuanti.aspx.cs" Inherits="zhuanti" %>
...
<body>
    ...
    <asp:Image ID="Image2" runat="server"   BackColor=White BorderWidth=10px BorderColor=#8080FF Width=600px
    ImageUrl="~/img/gooff.jpeg"/>
    </div>
</div>
<div id="footer">
	<ul>
